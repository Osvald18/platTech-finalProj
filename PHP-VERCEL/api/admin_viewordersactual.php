                  ...
                  <tbody>
                      <!-- Example rows, replace with dynamic content -->
                       ...
                       <?php
                        ...
                        $sql = "SELECT  order_ID,fkcustomer_ID,total_amount,order_status,order_date FROM orders";
                        ...
                        echo "<tr>
                          ...
                          <td>$row[fkcustomer_ID]</td>
                               <td>$row[total_amount]</td>
                                   <td>$row[order_status]</td>
                          <td>$row[order_date]</td>
                          <td>
                           <a class = 'btn btn-primary btn-sm' style='background-color: #9dbab3; border: none; color: white;' href = 'admin_editOrdersactual.php?order_ID=$[order_ID]'>Edit</a>
                          
                          <a class = 'btn btn-primary btn-sm' style='background-color: #9dbab3; border: none; color: white;' name = 'delete_button' href = 'admin_viewProducts.php?product_ID=$row[order_ID]'>Delete</a>
                            </td>
                      </tr>";
                        }
